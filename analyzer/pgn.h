...
Pgn pgnList[] = {
    ...
    {"ISO Acknowledgement",
     ...
     {LOOKUP_FIELD("Control", BYTES(1), ISO_CONTROL),
      ...
      RESERVED_FIELD(24),
      PGN_FIELD("PGN Data", "Parameter Group Number of requested information"),
      END_OF_FIELDS},
     .interval    = UINT16_MAX,
     .priority    = 6,
    ...
    {"ISO Request",
     ...
     PACKET_COMPLETE,
     PACKET_SINGLE,
     {PGN_FIELD("PGN Data", NULL), END_OF_FIELDS},
     .interval    = UINT16_MAX,
     .priority    = 6,
    ...
    */
    ...
    {"NMEA - Request group function",
     ...
     {MATCH_LOOKUP_FIELD("Function Code", BYTES(1), 0, GROUP_FUNCTION),
      PGN_FIELD("PGN Data", "Requested PGN"),
    ...
    {"NMEA - Command group function",
     ...
     {MATCH_LOOKUP_FIELD("Function Code", BYTES(1), 1, GROUP_FUNCTION),
      PGN_FIELD("PGN Data", "Commanded PGN"),
    ...
    {"PGN List (Transmit and Receive)",
     ...
     PACKET_COMPLETE,
     PACKET_FAST,
     {LOOKUP_FIELD("Function Code", BYTES(1), PGN_LIST_FUNCTION), PGN_FIELD("PGN Data", NULL), END_OF_FIELDS},
     .interval        = UINT16_MAX,
